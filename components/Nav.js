        ...
        <aside
            ...
            <nav className={"flex flex-col gap-2"}>
                ...
                <Link href={'/admins'} className={pathname.includes('/admins') ? activeLink : inactiveLink}>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname === '/admins' ? activeIcon : inactiveIcon}>
                ...
                <button
                    ...
                    <svg
                        className={inactiveIcon} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
